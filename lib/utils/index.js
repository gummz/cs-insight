...
function batchRequest(uri, items, options, callback) {
  ...
  var itemsPerBatch = options.itemsPerBatch || 1;
...
module.exports = {
  ...
  batchGetRequest: require('./batch-get-request'),
  batchPostRequest: require('./batch-post-request'),
  getRequest: require('./get-request'),
